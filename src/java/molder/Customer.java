...
public class Customer {
    ...
    public String toString() {
        return "Customer{" + "customerId=" + customerId + ", customerName=" + customerName + ", customerAge=" + customerAge + ", customerEmail=" + customerEmail + ", customerPassword=" + customerPassword + ", customerGender=" + customerGender + ", customerAddress=" + customerAddress + ", customerCity=" + customerCity + ", customerAvatar=" + customerAvatar + ", customerPhoneNumber=" + customerPhoneNumber + ", customerDOB=" + customerDOB + ", customerStatus=" + customerStatus + ", roleId=" + roleId + '}';
    }
